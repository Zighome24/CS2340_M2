 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Justin Ziegler");
		  toPrint += p1.toString("jziegler7");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Will Epperson");
		  toPrint += p2.toString("wepperson6");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Chris O'Brien");
		  toPrint += p3.toString("cobrien42");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Amanda Billings");
          toPrint += p4.toString("abillings3");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Nick Worthington");
          toPrint += p5.toString("nworthington3");
